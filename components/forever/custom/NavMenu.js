...
function NavMenu({ name, url, Megamenu, id }) {
          ...
          >
            <div className="container flex flex-wrap justify-between w-full">
              ...
              <ul className="px-4 pt-6 pb-6 ">
                ...
                {Megamenu &&
                  Megamenu.skinTypes?.map((item, index) => (
                    ...
                    >
                      <Link href={"/product/byskintype/" + item?.id}>
                        <p className="block p-1 text-primary hover:text-slate-900 font-['WorkSons'] cursor-pointer">
                          {item.skinType}
                        </p>
                      </Link>
              ...
              <ul className="px-4 pt-6 pb-6 ">
                ...
                {Megamenu &&
                  Megamenu.ranges?.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <Link href={"/product/byproductrange/" + item?.id}>
                          <p className="block p-1 text-primary hover:text-slate-900 font-['WorkSons'] cursor-pointer">
                            {item.range}
                          </p>
                        </Link>
                ...
                >
                  <Link href={"/product/viewmore/" + id}>
                    <p className="block p-1 text-primary hover:text-slate-900 font-['WorkSons'] cursor-pointer font-bold">
                      View More..
                    </p>
                  </Link>
                </li>
                ...
                {Megamenu &&
                  Megamenu.brands?.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <Link href={"/product/bybrand/" + item?.id}>
                          <p className="block p-1 text-primary hover:text-slate-900 font-['WorkSons'] cursor-pointer">
                            {item.brand}
                          </p>
                        </Link>
